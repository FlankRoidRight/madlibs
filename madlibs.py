...
This is because {person1} loves {person2}’s {adj1} {bodypart1}. \
However, {person2} does not like {person1}’s {adj2} {bodypart2}. \
{person1} likes to rub his {adj2} {bodypart2}, \
and this makes {person2} annoyed. \
Also, {person2} wants to {verb1} and {verb2} with {person1}, \
but {person1} is often too {emotion1} to do this. \
